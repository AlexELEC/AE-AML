...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs zip unzip pciutils usbutils parted procps-ng gptfdisk libtirpc wget"
...
makeinstall_target() {
  mkdir -p $INSTALL/usr/bin
    ...
    cp $PKG_DIR/scripts/boot_info $INSTALL/usr/bin/
